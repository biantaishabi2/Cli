...
var daemonCmd = &cobra.Command{
	...
	Long:  "长驻进程，定期检查 GitHub Project 或 Linear 中的 issue 状态，自动派发 niuma fix 执行",
	RunE:  runDaemon,
}
...
func runDaemon(cmd *cobra.Command, args []string) error {
	...
	executor := &daemon.CLIExecutor{RepoDir: flagRepoDir}
	...
	log.Printf("[daemon] 启动，tracker=%s，轮询间隔=%s", cfg.Daemon.Tracker, daemonCfg.PollInterval)
	return d.Run(ctx)
}
